...
const Email = () => {
    ...
    const ShowAlert = () => {
        if (!validEmail) {
            ...
            toast(`Thank you for subscribe us.Your Email is : ${emailValue}`)
        }
    }
    return (
        <section className="pt-[60px] md:pt-[80px] lg:pt-[120px] relative overflow-hidden">
            ...
            <div className="container">
                <div className="bg-[#00D09C] py-[40px] sm:py-[40px] lg:py-[94px] px-[20px] sm:px-[30px] lg:px-[52px] rounded-[8px]">
                    <div className="flex flex-col lg:flex-row items-center gap-[30px] lg:gap-0">
                        ...
                        <div className="w-full lg:w-auto">
                            <div className="bg-white min-w-full lg:max-w-[559px] 2xl:min-w-[559px] flex flex-col sm:flex-row items-stretch sm:items-center gap-[15px] sm:gap-0 sm:justify-between rounded-[20px] sm:rounded-full py-[15px] sm:py-2 px-[20px] sm:pl-[33px] sm:pr-[9px] shadow-lg">
                                <input
                                ...
                                />
                                <button onClick={ShowAlert} className="bg-[#2F57EF] flex items-center justify-center gap-[10px] sm:gap-3 py-[15px] sm:py-[20px] px-[25px] sm:px-[30px] rounded-[15px] sm:rounded-full cursor-pointer hover:bg-[#1e3ba8] transition-all duration-300 hover:scale-105 active:scale-95 shadow-md">
