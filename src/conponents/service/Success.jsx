...
const SlideItems = ({ image }) => {
    return (
        <div className="pt-[20px] pb-[29px] px-[30px] rounded-[5px] bg-white max-w-[410px] knowledge_shawow mx-[30px] group">
            <Link href={"/servicedetails"}>
                ...
                <div className="relative rounded-[5px] overflow-hidden">
                    <Image className="group-hover:scale-[1.1] transition-all ease-in-out duration-500" src={image} alt="image" />
                ...
                <h2 className="text-[25px] leading-[32.5px] text-primary font-bold pt-4 group-hover:text-secondary transition-all">The Power of Personal Branding</h2>
...
const NextArrow = (props) => {
    const { onClick } = props
    return <button onClick={onClick} className="size-[67px] rounded-full flex items-center justify-center border border-[#192335] hover:bg-secondary hover:border-0 group transition-all absolute top-[-70px] md:top-[-90px] lg:top-[-110px] right-[20px] md:right-[35px] lg:right-[50px]">
        <div>
...
const PrevArrow = (props) => {
    const { onClick } = props
    return <button onClick={onClick} className="size-[67px] rounded-full flex items-center justify-center border border-[#192335] hover:bg-secondary hover:border-0 group transition-all absolute top-[-70px] md:top-[-90px] lg:top-[-110px] right-[80px] md:right-[110px] lg:right-[140px]">
