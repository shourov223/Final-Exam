        ...
        <section className="vision_bg pt-[60px] md:pt-[119px] pb-[60px] md:pb-[113px]">
            <div className="container px-4">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-[30px] lg:gap-[56px] justify-between">
                    ...
                    <form data-aos="fade-left" className="w-full lg:w-auto">
                        <div className="flex flex-col sm:flex-row items-center gap-[20px] sm:gap-[29px] mb-[20px]">
                            <input type="text" className="py-[20px] px-[19px] placeholder:text-[17px] placeholder:text-white border border-[#E3E3E3] text-white rounded-[5px] w-full sm:w-[300px] outline" placeholder="Your Name" />
                            <input type="email" className="py-[20px] px-[19px] placeholder:text-[17px] placeholder:text-white border border-[#E3E3E3] text-white rounded-[5px] w-full sm:w-[300px] outline" placeholder="Your Email" />
                        </div>
                        ...
                        <div className="w-full sm:w-[629px] rounded-[5px] h-[130px] border border-[#E3E3E3] mt-[20px] py-[15px] px-[19px]">
