        ...
        <section className="absolute w-full h-full top-[125px] left-0">
            <div className="bg-[#192335] relative w-full">
                ...
                <div className="w-full">
                    <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10 lg:gap-[177px] px-4 md:px-12 lg:px-[100px] xl:pl-[315px] py-12">
                        <div className="text-center lg:text-left">
                            <p className="text-[16px] md:text-[18px] font-bold text-[#4ADA85] leading-[28px] md:leading-[31.5px] tracking-[-0.3px] pb-[11px]">
                                Click Learn Thrive
                            </p>
                            <h1 className="text-white font-bold text-[32px] md:text-[44px] lg:text-[59px] leading-[40px] md:leading-[56px] lg:leading-[71.4px] max-w-[500px] mx-auto lg:mx-0 pb-[17px]">
